...
func main() {
	println(t(testcase))
	println(traverse(0, 0, testcase))
	//println("part1 ->", solve(part1))
	//println("part2 ->", solve(part2))
}
func t(contents []int) int {
	steps := 0
	i := 0
	for i > -1 && i < len(contents) {
		old := i
		steps += 1
		jump := contents[i]
		i += contents[i]
...
func traverse(i, steps int, list []int) int {
